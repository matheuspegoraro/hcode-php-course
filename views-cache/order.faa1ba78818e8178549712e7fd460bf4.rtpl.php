    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <address>
                ...
                <?php echo utf8_encode($order["desaddress"]); ?>, <?php echo htmlspecialchars( $order["descomplement"], ENT_COMPAT, 'UTF-8', FALSE ); ?><br>
        ...
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>R$<?php echo formatPrice(getTotalPriceProduct($value1["nrqtd"], $value1["vlprice"])); ?></td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
